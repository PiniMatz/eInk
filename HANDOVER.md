...
| Commit | Description |
| :--- | :--- |
| `HEAD` | **Ingest Sahar Kat-Sal League Schedule (12 games):** Ingested all 12 league games for Sahar's team ("הפועל מ.ק. פרדסיה תפוז" - קט-סל ב' לב השרון) into Firestore and Google Calendar (`hugim.kid@gmail.com`); set 90-minute duration, game venue/location, home/away status, and opponent team name. |
| `7d812b7` | **Add Sahar athletics sessions (22/9 & 28/9):** Added Sahar's athletics practice for Tuesday 22/9 (12:30-13:15) and Monday 28/9 (13:45-14:30), superseding the old 15:30 recurring occurrence; synced to Firestore and Google Calendar (`hugim.kid@gmail.com`). |
